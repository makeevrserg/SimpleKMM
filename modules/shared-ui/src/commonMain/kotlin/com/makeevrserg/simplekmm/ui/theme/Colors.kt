...
object Colors {
    val colorPrimary: Color = Color(0xFFFFFFFF)
    val colorPrimaryVariant: Color = Color(0xFFEBEBEB)
    val colorHint: Color = Color(0xFF888888)
    val colorHintVariant: Color = Color(0xFFD9D9D9)
